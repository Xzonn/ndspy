...
# -*- coding: utf-8 -*-
#
# ndspy documentation build configuration file, created by
# sphinx-quickstart on Sun Mar 26 02:37:14 2017.
#
...
project = 'ndspy-xzonn'
copyright = '2020, RoadrunnerWMC; 2026, Xzonn'
...
latex_documents = [
    (master_doc, 'ndspy.tex', 'ndspy Documentation',
     'RoadrunnerWMC', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndspy', 'ndspy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndspy', 'ndspy Documentation',
     author, 'ndspy', 'Library for common Nintendo DS files.',
     'Miscellaneous'),
]
